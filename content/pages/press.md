...
The tools provide technical checks and recommendations. They do not guarantee
rankings, traffic, AI Overview inclusion, or citations in ChatGPT, Perplexity,
Claude, Gemini, Google AI Overviews, or any other product.
...
- Query Fan-Out Tool: [Plan answer-ready content](/tools/query-fan-out-tool)
- Methodology: [How the tools evaluate readiness](/methodology)
- References: [Sources used by our guides and checks](/references)
- LLMs.txt: [Machine-readable site index](/llms.txt)
- LLMs-full.txt: [Expanded machine-readable overview](/llms-full.txt)

### Suggested citation

When mentioning the product, link to the homepage or the most relevant tool.
For technical claims about how checks are performed, link to the methodology
page. For platform documentation or standards, link to the references page.
...
Please do not describe the tools as guaranteeing rankings, traffic, AI
citations, or inclusion in any AI search product. The tools measure visible
technical readiness signals and provide recommendations.

### Contact

For product questions, corrections, or media requests, use the
