...
export function AIHomePage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden border-b border-zinc-800/50">
        ...
        <Container className="relative py-24 lg:py-32">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-zinc-700/50 bg-zinc-900/50 px-4 py-1.5 text-sm text-zinc-400">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <a href="/best-ai-visibility-tools" className="inline-flex items-center gap-2 rounded-xl bg-zinc-50 px-6 py-3 text-sm font-semibold text-zinc-900 transition-all hover:bg-zinc-200 active:scale-[0.98]">
                Compare Tools <IconArrowRight size={16} />
              </a>
              <a href="/ai-visibility-checker" className="inline-flex items-center gap-2 rounded-xl border border-zinc-700 bg-zinc-900/50 px-6 py-3 text-sm font-medium text-zinc-300 transition-all hover:border-zinc-600 hover:bg-zinc-800/50 active:scale-[0.98]">
        ...
        <Container>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {features.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="group rounded-2xl border border-zinc-800/60 bg-zinc-900/30 p-6 transition-all hover:border-zinc-700 hover:bg-zinc-900/60">
        ...
        <Container>
          <div className="mb-10 flex items-end justify-between">
            <div>
              ...
              <p className="mt-2 text-zinc-400">Hand-picked tools for tracking brand presence across AI search.</p>
            </div>
            <a href="/best-ai-visibility-tools" className="hidden sm:inline-flex items-center gap-1.5 text-sm text-blue-400 hover:text-blue-300 transition-colors">
          ...
          <div className="mt-8 text-center sm:hidden">
            <a href="/best-ai-visibility-tools" className="text-sm text-blue-400 hover:text-blue-300">View all 10 tools →</a>
          </div>
        </Container>
      </section>
      ...
      <section className="border-t border-zinc-800/50 py-20">
        <Container>
          <h2 className="text-center text-2xl font-bold text-zinc-100">Use Cases</h2>
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={uc.title} className="rounded-2xl border border-zinc-800/60 bg-zinc-900/20 p-6 transition-colors hover:border-zinc-700">
                <h3 className="font-semibold text-zinc-200">{uc.title}</h3>
                <p className="mt-2 text-sm leading-relaxed text-zinc-400">{uc.desc}</p>
              </div>
            ))}
          </div>
        </Container>
      ...
      <section className="border-t border-zinc-800/50 py-20">
        <Container>
          <div className="relative overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-br from-blue-950/40 via-zinc-900 to-zinc-950 px-8 py-14 text-center">
            <div className="absolute top-0 right-0 w-80 h-80 bg-emerald-600/5 rounded-full blur-3xl" />
            <h2 className="relative text-2xl font-bold text-zinc-100">Ready to Start Tracking?</h2>
            <p className="relative mt-3 text-zinc-400">Try our free AI visibility checker or compare tools to find your best fit.</p>
            <div className="relative mt-8 flex flex-wrap justify-center gap-4">
              <a href="/ai-visibility-checker" className="inline-flex items-center gap-2 rounded-xl bg-zinc-50 px-6 py-3 text-sm font-semibold text-zinc-900 transition-all hover:bg-zinc-200 active:scale-[0.98]">
                Free AI Visibility Checker <IconArrowRight size={16} />
              </a>
              <a href="/best-ai-visibility-tools" className="inline-flex items-center gap-2 rounded-xl border border-zinc-600 bg-zinc-800/50 px-6 py-3 text-sm font-medium text-zinc-300 transition-all hover:border-zinc-500 active:scale-[0.98]">
                Compare Tools
              </a>
            </div>
          </div>
      ...
      <section className="border-t border-zinc-800/50 py-20">
        <Container>
          <div className="mx-auto max-w-2xl">
            <h2 className="text-center text-2xl font-bold text-zinc-100">Frequently Asked Questions</h2>
