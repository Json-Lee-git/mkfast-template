/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 066bcc76d08f7bcaddfcf9abe6df1e97)
// Runtime types generated with workerd@1.20260424.1 2026-06-01 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		CREEM_PRODUCT_FULL_REPORT: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		RESEND_API_KEY: string;
		FAL_KEY: string;
		DEVTO_API_KEY: string;
		CREEM_PRODUCT_MANUAL_AUDIT: string;
	}
	interface Env {
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_API_TOKEN: string;
		...
		DB?: D1Database;
		AI?: Ai;
		PUBLIC_SITE_URL?: "https://aeocheck.xyz";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_DATABASE_ID" | "BETTER_AUTH_SECRET" | "VITE_PAYMENT_PROVIDER" | "CREEM_DEBUG" | "CREEM_API_KEY" | "CREEM_WEBHOOK_SECRET" | "VITE_CREEM_PRODUCT_PRO_MONTHLY" | "VITE_CREEM_PRODUCT_PRO_YEARLY" | "VITE_CREEM_PRODUCT_LIFETIME" | "CREEM_PRODUCT_FULL_REPORT" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "FAL_KEY" | "DEVTO_API_KEY" | "CREEM_PRODUCT_MANUAL_AUDIT" | "PUBLIC_SITE_URL">> {}
}
